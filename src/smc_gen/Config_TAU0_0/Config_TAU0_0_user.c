...
volatile uint32_t g_tau0_ch0_width = 0UL;
...
{
    if (1U == (TSR00 & _0001_TAU_OVERFLOW_OCCURS))    /* overflow occurs */
    {
        g_tau0_ch0_width = (uint32_t)(TDR00 + 1UL) + 0x10000UL;
    }
    else
    {
        g_tau0_ch0_width = (uint32_t)(TDR00 + 1UL);
    }
