...
void R_Config_TAU0_0_Create(void)
{
    ...
    TMPR100 = 1U;
    TMPR000 = 1U;
    /* TAU00 is used to measure input pulse interval */
    TIS0 &= _C7_TAU_CH0_INPUT_TI00;
    NFEN1 &= (uint8_t)~_01_TAU_CH0_NOISE_ON;
    TMR00 = _0000_TAU_CLOCK_SELECT_CKM0 | _0000_TAU_CLOCK_MODE_CKS | _0100_TAU_TRIGGER_TIMN_VALID | 
            _0080_TAU_TIMN_EDGE_BOTH_LOW | _0004_TAU_MODE_CAPTURE | _0000_TAU_START_INT_UNUSED;
